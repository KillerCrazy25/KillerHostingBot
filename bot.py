...
bot = bridge.Bot(command_prefix = commands.when_mentioned_or("!"), intents = discord.Intents.all())
...
@bot.bridge_command(description = "Manage Bot Extensions (ADMIN ONLY).", guild_ids = [918985655449681930])
